...
<body>
      ...
      <div class="container">
         <div class="row">
            <div class="col-6 col-sm-6 col-md-2 py-1">
               <a href="index.html">
                  <img src="public/images/mstyle.png" class="img-fluid" alt="Logo">
               </a>
            </div>
            ...
            <div class="col-12 col-sm-12 d-none d-md-block col-md-4 text-center py-2">
               ...
               <div class="fs-6 py-2">
                  ĐỔI TRẢ HÀNG HOẶC HOÀN TIỀN <span class="text-warning">TRONG 3 NGÀY</span>
               </div>
            </div>
   ...
   <section class="hdl-mainmenu bg-warning ">
      <div class="container">
         <div class="row">
