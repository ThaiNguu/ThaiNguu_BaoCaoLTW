         ...
         <div class="row">
            <div class="col-md-6">
               ...
               <div class="mb-3">
                  ...
                  <input type="text" name="email" value="<?=$customer->email;?>" id="phone" class="form-control" placeholder="Nhập email" readonly>
               </div>
               <div class="mb-3">
               ...
               <div class="text-end">
                  <button type="submit" name="XACNHAN" class="btn btn-warning px-4">XÁC NHẬN</button>
               </div>
               <?php endif;?> 
               </form>
            </div>
