         ...
         <section class="content">
            <div class="card">
               <div class="card-header">
                  ...
                  <div class="col-md-6 text-right"><a href="index.php?option=topic" class="btn btn-sm btn-info">
               ...
               <div class="card-body">
                  <div class="row">
                     ...
                     <div class="card-body">
                        <div class="row">
                     <div class="col-md-12">
                        <table class="table table-btopiced">
                           <thead>
                              <tr>
                           ...
                           <?php if (count ($list) > 0) : ?> 
                              ...
                              <tr class="datarow">
                                 ...
                                 <td>
                                    <img src="../public/images/topic/<?php  $item->image; ?>" alt="<?php  $item->image; ?>">
                                 </td>
                                 <td>
                                    <div class="name">
                                    <?= $item->name; ?>
