         ...
         <section class="content">
            <div class="card">
               <div class="card-header">
                  <div class="row">
                  <div class="col-md-12 text-right"><a href="index.php?option=page" class="btn btn-sm btn-info">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        <table class="table table-bordered">
                         ...
                         <tr>
                           <td>Chi tiết trang đơn</td>
                           <td><?=$post->detail;?></td>
                         </tr> 
                         
                         <tr>
                           <td>Hình ảnh</td>
                           <td><img style="width:100px;" src="../public/images/post/<?=$post->image;?>"></td>
                         </tr> 
                         <tr>
                           <td>Kiểu bài viết</td>
                           <td><?=$post->type;?></td>
