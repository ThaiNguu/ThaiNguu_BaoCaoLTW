         ...
         <section class="content">
            <div class="card">
               <div class="card-header">
                  ...
                  <div class="col-md-6 text-right"><a href="index.php?option=contact" class="btn btn-sm btn-info">
                        ...
                        <table class="table table-bordered">
                           ...
                           <?php if (count ($list) > 0) : ?> 
                              ...
                              <tr class="datarow">
                                 ...
                                 <td>
                                    <img src="../public/images/contact/<?php  $item->image; ?>" alt="<?php  $item->image; ?>">
                                 </td>
                                 <td>
                                    <div class="name">
                                    <?= $item->name; ?>
